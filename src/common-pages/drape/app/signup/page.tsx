            ...
            <div className="flex w-full lg:w-1/2 flex-col items-center justify-center p-8 bg-black">
                <div className="flex flex-col items-start w-full max-w-[320px] gap-8">
                    <Link href="/" className="block transition-opacity hover:opacity-80">
                        <img src="/drape-logo.svg" alt="Drape" className="h-12 w-auto" />
                    </Link>
                    ...
                    <p className="text-xs text-white/25 leading-relaxed">
                        ...
                        <Link href="/pages/drape/terms.html" className="underline hover:text-white/60 transition-colors">
                            Terms of Service
                        </Link>{" "}
                        and{" "}
                        <Link href="/pages/drape/privacy.html" className="underline hover:text-white/60 transition-colors">
                            Privacy Policy
                        </Link>
                        .
                    </p>
