...
export default function ContactPage() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        const mailto = `mailto:hello@drape.cloud?subject=${encodeURIComponent(subject || "Contact from Drape")}&body=${encodeURIComponent(body)}`;
    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans selection:bg-white/20 flex flex-col">
            ...
            <main className="flex-1 mx-auto w-full max-w-4xl px-5 py-24 pt-[200px] text-left">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-10 text-white">Contact</h1>
