    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans selection:bg-white/20 flex flex-col">
            ...
            <main className="flex-1 mx-auto w-full max-w-[1100px] px-5 py-24 pt-[200px]">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-10 text-white">Terms of Use</h1>
                ...
                <div className="space-y-12 w-full max-w-[1100px]">
                    ...
                    <section>
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Welcome to Drape! By accessing or using our website and services, you agree to be bound by these Terms of Use. If you do not agree with any part of these terms, please do not use the service.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Drape is a browser-based creative studio for generating websites, presentation decks, multi-page editorial layouts, and AI-powered visuals. By using the platform, you agree to use it responsibly and in accordance with applicable laws.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Content you create in Drape remains yours, unless otherwise stated. The Drape platform, brand, software, and underlying technologies are owned by the company and may not be copied, resold, or used without permission.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Drape includes AI-assisted tools for image generation, image editing, vector generation, site generation, and presentation building. Results can vary and may not exactly match prompts, source content, or intended outcomes.
                        </p>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Drape is provided "as is" without warranties of any kind. We are not liable for any direct, indirect, incidental, or consequential damages arising from your use of the service, including loss of data, project files, or design outputs.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            We reserve the right to suspend or terminate access to Drape for any reason, including violation of these terms.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Your use of Drape is also governed by our <Link href="/pages/drape/privacy.html" className="underline hover:text-white transition-colors">Privacy Policy</Link>, which explains how we handle your data and project content.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            If you have any questions about these Terms of Use, please <Link href="/pages/drape/contact.html" className="underline hover:text-white transition-colors">contact us</Link>.
                        </p>
                    </section>
