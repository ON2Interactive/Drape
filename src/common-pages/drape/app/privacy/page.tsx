    ...
    return (
        <div className="min-h-screen bg-black text-white font-sans selection:bg-white/20 flex flex-col">
            ...
            <main className="flex-1 mx-auto w-full max-w-[1100px] px-5 py-24 pt-[200px]">
                <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-10 text-white">Privacy Policy</h1>

                <div className="space-y-12 w-full max-w-[1100px]">
                    ...
                    <section>
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed font-regular mb-4">
                            Drape ("Drape", "we", "our", or "us") respects your privacy and is committed to protecting it through this Privacy Policy. This policy explains how we collect, use, disclose, and safeguard your information when you use the Drape website, application, and related services (collectively, the "Service").
                        </p>
                        <p className="text-sm md:text-base text-white/50 leading-relaxed font-regular">
                            By accessing or using Drape, you agree to the terms of this Privacy Policy.
                        </p>
                    </section>
                    ...
                    <section className="space-y-6">
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-sm md:text-base text-white/50 leading-relaxed">When you use Drape, we may collect:</p>
                            <BulletList items={[
                        ...
                        <div className="space-y-4">
                            ...
                            <p className="text-xs text-white/30 italic">This information is used solely to operate, secure, and improve Drape.</p>
                        </div>

                        <div className="space-y-4">
                            <h3 className="text-base font-bold text-white tracking-tight">1.3 Design and Content Data</h3>
                            <p className="text-sm md:text-base text-white/50 leading-relaxed">
                                Content you create in Drape (such as designs, layouts, or uploaded assets) is stored only to provide the Service to you.
                            </p>
                    ...
                    <section className="space-y-4">
                        ...
                        <BulletList items={[
                            "Provide, operate, and maintain Drape",
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">Drape offers sign-in via Google OAuth.</p>
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Drape's use of information received from Google APIs adheres to the Google API Services User Data Policy, including the Limited Use requirements.
                        </p>
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Drape does not store or process full payment card details. Payment providers handle this information according to their own privacy and security policies.
                        </p>
                    </section>

                    <section className="space-y-4">
                        <h2 className="text-lg md:text-xl font-bold text-white tracking-tight">5. Cookies and Tracking</h2>
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">Drape may use essential cookies or similar technologies to:</p>
                        <BulletList items={[
                    ...
                    <section className="space-y-4">
                        ...
                        <BulletList items={[
                            ...
                            "To protect the safety and integrity of Drape and its users"
                        ]} />
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                    ...
                    <section className="space-y-4">
                        ...
                        <p className="text-sm md:text-base text-white/50 leading-relaxed">
                            Drape is not intended for children under the age of 13. We do not knowingly collect personal data from children.
                        </p>
                    </section>
                    ...
                    <section className="space-y-4">
                        ...
                        <BulletList items={[
                            "Email: hello@drape.cloud",
                            "Website: https://drape.cloud"
                        ]} />
                        <p className="text-xs text-white/30 italic mt-4">
                            Drape uses your Google account information solely for secure authentication. We do not sell, share, or use your data for advertising.
                        </p>
                    </section>
